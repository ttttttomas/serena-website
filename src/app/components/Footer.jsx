...
export default function Footer() {
    return (
        <footer>
      <ul className='flex justify-between items-center px-10 py-5 gap-x-10 bg-orangeMedium text-white'>
        ...
        <section className="">
            <div className="flex justify-between">
                ...
                <div className="flex flex-col gap-5 pt-10" id="ubicanos">
                ...
                <div className="pt-10 flex flex-col gap-5" id="atencion">
                <h3 className="font-bold text-xl">Horario de atención</h3>
                  <p>
                    Lunes a sábado de 09:30 hs a 19:00 hs
                    </p>
                  <p>
                    <img src="/ministerio.png" alt="" width="175px" />
                  </p>
                  <p>
                    Legajo <span className="font-bold">11999</span>
                  </p>
                </div>
                <div className="flex flex-col items-end gap-5 py-10 px-5 rounded-bl-[110px] bg-creamBg" id="contacto">
                ...
                <div className="flex flex-col justify-center items-center">
                   <p className={`${moonDance.className} text-xl`}>Razon social: Trappberger, Cynthia Liana - Cuit: 27-23174619-1 </p> 
                   <p></p>
